...
public class RunAndQueryDrivenScheduler extends Scheduler implements Runnable {
	...
	public RunAndQueryDrivenScheduler (AtomicInteger dp, HashMap<RunID,Run> rs, RunQueues rq, RunQueues hprq,ExecutorService e, 
								CountDownLatch tn, CountDownLatch d, int lastR, boolean unidir, int lastS, long start, AtomicInteger x0, AtomicInteger x1, int hpf, int lpf) {		
		super(dp,rs,rq,e,tn,d,lastR,unidir,lastS,start);
		HPrunqueues = hprq;
